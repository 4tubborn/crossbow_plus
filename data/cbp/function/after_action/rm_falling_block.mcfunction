...
data modify entity @n[type=!falling_block,tag=item_projectiles,type=!item,type=!arrow,distance=..5] Owner set from entity @p[tag=cbp.player] UUID
data modify entity @n[type=tnt,tag=item_projectiles,distance=..5] owner set from entity @p[tag=cbp.player] UUID
